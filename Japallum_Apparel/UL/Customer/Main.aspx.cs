...
namespace UL
{
    public partial class main : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Clothes mensShirt1 = new Clothes("Generic Shirt", 000001, "Large", 10.00, "shirts", "This shirt has a new style that is in fashion at the moment!", "male", "~/Images/Mens_shirt.jpg");
            ...
            Clothes mensPants1 = new Clothes("Generic Pants", 000002, "36", 20.00, "pants", "These pants are the hottest on the market right now!", "male", "~/Images/Mens_pants.jpg");
            ...
            Clothes mensFootwear1 = new Clothes("Generic Shoes", 000003, "11", 50.00, "footwear", "You'll be running everywhere with these bad boys!", "male", "~/Images/Mens_footwear.jpg");
            ...
            Clothes womensShirt1 = new Clothes("Pretty Shirt", 000004, "small", 10.00, "shirts", "A very pretty shirt!", "female", "~/Images/Womens_shirt.jpg");
            ...
            Clothes womensPants1 = new Clothes("Sexy Pants", 000005, "small", 20.00, "pants", "These pants are the hottest on the market right now!", "female", "~/Images/Womens_pants.jpg");
            // Footwear image sourced from - http://heelsme.com/wp-content/uploads/2016/09/Womens-Red-High-Heels-5orhlmxgze2.jpg
            Clothes womensFootwear1 = new Clothes("High Heel Shoes", 000006, "6", 50.00, "footwear", "Very fancy high heels!", "female", "~/Images/Womens_footwear.jpg");
            ...
            Clothes youthShirt1 = new Clothes("Playful shirt", 000007, "Large", 5.00, "shirt", "fun in the sun with this awesome shirt!", "male", "~/Images/Youth_shirt.jpg");
            ...
            Clothes youthPants1 = new Clothes("Happy pants", 000008, "36", 10.00, "pants", "These pants will make you play all day!", "female", "~/Images/Youth_pants.jpg");
            // Footwear image sourced from - http://fallinginstyle.net/wp-content/uploads/2013/08/Reebok-Kids-ATV19-shoes-2.jpg
            Clothes youthFootwear1 = new Clothes("Kids shoes", 000009, "11", 25.00, "footwear", "You'll be the coolest kid in school with these!", "male", "~/Images/Youth_footwear.jpg");
